...
class Syringe:
    ...
    def set_start(self, new_position):
...
#             return True # Returns True to signify that the Syringe has a loaded script and just run it. Whoever calls this function can then print a status message with the name of the Syringe
#         else:
#             return False # Returns False to signify that the Syringe doesn't have a loaded script
